...
This quickstart will showcase how to set up a web push notification architecture for the ACS Web Calling SDK. We will walk through the set up steps necessary to set up the architecture. For this architecture, we will be sending the web push notifications via OneSignal, a truedte web push service provider.
...
- From our calling-web-push-notifications folder in Visual Sutdio Code. Open the `./IncomingCallListener_FunctionApp/HandleIncomingCallEvent/index.js` file:
    ...
    <img src="./assets/createFunctionAppVscodeEdit.png" style="width: 2000px;"/>
<br></br>
...
<img src="./assets/createFunctionAppOpenInFileExplorer.png" style="width: 700px;"/>
<br></br>
...
<img src="./assets/createFunctionAppZip.png" style="width: 1000px;"/>
<br></br>
- The .zip file will be creted, you can name it "IncomingCallListener_FunctionApp.<b>zip</b>":
<img src="./assets/createFunctionAppZipCreated.png" style="width: 1000px;"/>
<br></br>
...
- Open the `./serverConfig.json` file and fill in the required fields:
    ...
    <img src="./assets/serverConfig.png" style="width: 800px;"/>
...
<img src="./assets/allowWebPushNotifications.png" style="width: 1500px;"/>
<br></br>
...
<img src="./assets/edgeAllow.png" style="width: 600px;"/>
