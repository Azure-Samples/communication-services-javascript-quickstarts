async function main( ) {
	...
	{
		console.error("missing phone number argument");
		return;
	}
    ...
    let formattingResults = await phoneNumbersClient.searchOperatorInformation([ phoneNumber ]);
    ...
    let searchResults = await phoneNumbersClient.searchOperatorInformation([ phoneNumber ], { "includeAdditionalOperatorDetails": true });
