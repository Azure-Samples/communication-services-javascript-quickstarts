...
It makes an outbound call to a phone number and plays audio and recognize speech. The application is a web-based application built on Express.js framework.
...
3. cd into the `CallAutomation_SendDtmfTones` folder.
